# A^2Q
We have provided the source code to reproduce the results of our paper **$\rm{A^2Q}$: Aggregation-Aware Quantization for Graph Neural Networks**. Due to time constraints, we first provide the code for the main experimental section (i.e., Section 4.2 and Section 4.3) in the main text to reproduce the results reported in our work.
